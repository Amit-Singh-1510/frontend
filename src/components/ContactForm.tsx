      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <button type="submit" suppressHydrationWarning className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
              Send Message
            </button>
            {status && (
              <div className={`mt-4 flex flex-col items-center justify-center text-center ${status.includes('success') ? 'text-green-600' : 'text-red-600'}`}>
                {status.includes('success') && <FaCheckCircle className="h-8 w-8 text-blue-500 mb-2" />}
